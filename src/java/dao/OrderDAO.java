...
public class OrderDAO {
    ...
    public boolean addOrderDetail(OrderDTO order) throws SQLException{
        boolean checkInsert = false;
        Connection conn = null;
        PreparedStatement ps = null;
        try {
    ...
    public List<OrderDTO> userOrders(int userId) throws SQLException {
    ...
    public OrderDTO accountMailData(int userId) throws SQLException {
        OrderDTO order = null;
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
