...
public class ProductDAO {
    ...
    public List<ProductDTO> getAllProduct() throws SQLException {
        ...
        try {
            ...
            if(conn != null){
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                listProduct.add(new ProductDTO(rs.getInt("id"),
                        rs.getString("name"),
                        rs.getString("image"),
                        rs.getInt("price"),
                        rs.getString("title"),
    ...
    public List<ProductDTO> getByAscPrice() throws SQLException {
        List<ProductDTO> listAsc = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        ...
        try {
            ...
            if(conn != null){
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                listAsc.add(new ProductDTO(rs.getInt("id"),
                        rs.getString("name"),
                        rs.getString("image"),
                        rs.getInt("price"),
                        rs.getString("title"),
    ...
    public List<ProductDTO> getByDesPrice() throws SQLException {
        List<ProductDTO> listDes = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        ...
        try {
            ...
            if(conn != null){
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                listDes.add(new ProductDTO(rs.getInt("id"),
                        rs.getString("name"),
                        rs.getString("image"),
                        rs.getInt("price"),
                        rs.getString("title"),
    ...
    public List<ProductDTO> getByCateID(int cateId) throws SQLException {
        List<ProductDTO> listCateID = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        ...
        try {
            ...
            if(conn != null){
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                listCateID.add(new ProductDTO(rs.getInt("id"),
                        rs.getString("name"),
                        rs.getString("image"),
                        rs.getInt("price"),
                        rs.getString("title"),
    ...
    public List<ProductDTO> getByName(String name) throws SQLException {
        ...
        try {
            ...
            if(conn != null){
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                listProductByName.add(new ProductDTO(rs.getInt("id"),
                        rs.getString("name"),
                        rs.getString("image"),
                        rs.getInt("price"),
                        rs.getString("title"),
        ...
        try {
            ...
            if(conn != null){
                ...
                if (rs.next()) {
                    ...
                    product = new ProductDTO(id, pName, pImage, pPrice, pTitle, pQuantity, pCateId);
            }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public List<ProductDTO> getBySellerId(int userId) throws SQLException {
        List<ProductDTO> listProductBySellerId = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            ...
            if(conn != null){
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                listProductBySellerId.add(new ProductDTO(rs.getInt("id"),
                        rs.getString("name"),
                        rs.getString("image"),
                        rs.getInt("price"),
                        rs.getString("title"),
